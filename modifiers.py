...
def add_solid_mesh_modifiers(obj, thickness=0.1, roundness=0.3, round_edges=False):
    """Add Solidify and optionally Bevel and Subdivision modifiers to a mesh object"""
